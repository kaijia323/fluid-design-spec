...
> 版本 v1.0 ｜ 来源：ColorOS 17 流体设计语言梳理 ｜ 标注 **※** 的条目为本规范补充定义，非官方原文。
...
| 元素 | 定义 | 设计意图 |
|---|---|---|
| **凝光视效** | 光不是装饰，而是界面意图的指引；光影随手势自然流动 | 把注意力引向关键信息 |
| **流体动效** | 无缝连贯的转场，从息屏到桌面一气呵成 | 让流畅成为可感知的日常体验 |
| **柔性反馈** | 界面元素随操作自然收缩、拉伸、回弹 | 提供真实且有生命力的触感回应 |
...
| 时期 | 版本 | 主张 |
|---|---|---|
| 无边界时期 | ColorOS 6–12 | 轻快无边界，去功利化设计 |
| 水生设计时期 | ColorOS 13–14 | 水生万物：自然、流畅、生命力 |
...
- 以人为中心。
- 直观、轻快、简约而富有设计感。
- 交互优化从**易用性、统一性、创新性**着手，前两者占 90% 精力。
- 跨端理念：打破设备壁垒，算力、数据、服务自由流转。
- 大屏适配：更大屏幕呈现更多内容，多种设备保持相似体验。
